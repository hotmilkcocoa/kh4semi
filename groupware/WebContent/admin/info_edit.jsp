...
<div class="outbox" style="width:900px;">
	...
	<form action="info_edit.do" method="post">
		...
		<table class="table table-border">
			<tbody>
				<tr>
					...
					<th width="20%">구분</th>
					<td width="30%">
						<label><input type="radio" name="com_type" value="법인" <%=companyDto.getCom_type().equals("법인")?"checked":"" %>>법인</label>
						<label><input type="radio" name="com_type" value="개인" <%=companyDto.getCom_type().equals("개인")?"checked":"" %>>개인</label>
					</td> 
				</tr>
				<tr>
					<th>사업자등록번호</th>
